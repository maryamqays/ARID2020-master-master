...
namespace ARID.Controllers
{
    public class PostMetricsController : Controller
    {
        ...
        public PostMetricsController(ARIDDbContext context, UserManager<ApplicationUser> userMrg)
        {
            _context = context;
        ...
        {
            var aRIDDbContext = _context.PostMetrics.Include(p => p.ApplicationUser).Include(p => p.Post);
