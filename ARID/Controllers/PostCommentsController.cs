...
namespace ARID.Controllers
{
    public class PostCommentsController : Controller
    {
        ...
        public PostCommentsController(ARIDDbContext context,UserManager<ApplicationUser> userMrg)
        {
            _context = context;
        ...
        {
            var aRIDDbContext = _context.PostComments.Include(p => p.ApplicationUser).Include(p => p.Post);
