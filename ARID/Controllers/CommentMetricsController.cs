...
namespace ARID.Controllers
{
    public class CommentMetricsController : Controller
    {
        ...
        public CommentMetricsController(ARIDDbContext context,UserManager<ApplicationUser> userMrg)
        {
            _context = context;
        ...
        {
            var aRIDDbContext = _context.CommentMetrics.Include(c => c.ApplicationUser).Include(c => c.PostComment);
