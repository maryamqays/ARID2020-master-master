...
namespace ARID.Controllers
{
    public class FileTypesController : Controller
    {
        ...
        public FileTypesController(ARIDDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FileName")] FileType fileType)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var fileType = await _context.FileTypes.SingleOrDefaultAsync(m => m.Id == id);
            if (fileType == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FileName")] FileType fileType)
        {
            if (id != fileType.Id)
            {
                return NotFound();
